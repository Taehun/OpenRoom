...
above. `pnpm mcp:openroom` runs `scripts/openroom-mcp/server.ts`: an
...
- `OPENROOM_MCP_PORT` (`0` or `1024`-`65535`, default `43110`) and
  `OPENROOM_ALLOWED_ORIGINS` (exact, comma separated) configure it.
