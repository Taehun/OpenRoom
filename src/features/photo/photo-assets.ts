...
export const ROOM_PHOTO_ASSETS = {
  empty: {
    id: "openinterior-room-empty",
    src: "/demo/photo/openinterior-room-empty.webp",
    intrinsicWidth: 1600,
    intrinsicHeight: 900,
  },
  before: {
    id: "openinterior-room-before",
    src: "/demo/photo/openinterior-room-before.webp",
    intrinsicWidth: 1600,
    intrinsicHeight: 900,
  },
} as const;

export const OPENINTERIOR_ROOM_BACKGROUND = ROOM_PHOTO_ASSETS.empty.src;
export const OPENINTERIOR_ROOM_BEFORE = ROOM_PHOTO_ASSETS.before.src;
